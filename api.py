...
class Api(object):
    ...
    def get_events(self):
        ...
        path = "/api/v2/users/" + str(self.uid) + "/events"
    ...
    def get_events(self):
        ...
        path = "/api/v2/users/" + str(self.uid) + "/friends"
    ...
    def get_method(self, uid, method):
        assert(self._access_token)

        path = "/api/v2/" + str(method)
